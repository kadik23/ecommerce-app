<template>
    ...
    <!-- <div class="container w-full h-full flex flex-row">
        <div class="flex h-full w-1/2 flex-1 flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div class="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" action="{{ route('login') }}" method="POST">
                    ...
                    <div>
                        <p>Or</p>
                        <img src="../assets/icons8-google-48.png" class="h-8 mx-auto mb-4 cursor-pointer" alt="">
        ...
        <div class="w-1/2 h-full flex flex-col ">
            ...
            <div class="px-8 py-8 h-1/2"  style="background-color: #f5ecd9;"> 
                ...
                <br>
                <button type="submit" class="flex w-1/6 mx-auto justify-center rounded-md bg-regal-brown  px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-amber-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2  " >Sign up</button>
            </div>
        </div>
