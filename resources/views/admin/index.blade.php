...
<div class="flex flex-wrap lg:flex-nowrap justify-between">
    ...
    <div class="lg:inline-block w-full lg:w-auto">
        <div class="m-3 p-2 flex flex-col bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            <h5 class="inline-block text-sm lg:text-xl font-bold text-gray-900 dark:text-white">Total Report</h5>
            <div class="flex flex-wrap text-center justify-around items-center bg-gray-50 rounded-md my-2 p-2">
                ...
                <h5 class="inline-block text-sm lg:text-xl font-bold text-gray-900 dark:text-white">Total profits </h5>
                <span>$150 </span>
            </div>
            <div class="flex flex-wrap text-center justify-around items-center bg-gray-50 rounded-md p-2">
                ...
                <h5 class="inline-block mr-6 text-sm lg:text-xl font-bold text-gray-900 dark:text-white">Revenue</h5>
                <span >$680 </span>
            </div>
        </div>

        <div class=" m-3 p-8 lg:p-0 max-w-md mt-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="flex items-center justify-between mb-4 ">
                <h5 class="text-sm lg:text-xl font-bold leading-none text-gray-900 dark:text-white">Latest Customers</h5>
