...
<form action="{{route('product.store')}}" method="POST" class="bg-white dark:bg-gray-800 m-3 p-5 rounded-lg flex flex-row justify-around text-gray-900 dark:text-white border border-gray-100 dark:border-gray-700 shadow" enctype="multipart/form-data">
    ...
    <div class="w-1/3">
        <div class="mb-6">
            <label for="name" class="block  mb-2 text-md font-medium text-gray-900 dark:text-white">{{ t('admin.products.product_name') }}</label>
        ...
        <div class="mb-6">
            <label for="price" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">{{ t('admin.products.price') }}</label>
        ...
        <div class="mb-6">
            <label for="category" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">{{ t('admin.products.category') }}</label>
        ...
        <div class="mb-6">
            <label for="qnt" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">{{ t('admin.products.quantity') }}</label>
        ...
        <div class="mb-6">
            <label for="sold" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">{{ t('admin.products.sold') }}</label>
        ...
        <button type="submit" class="text-white bg-regal-brown hover:bg-amber-700 focus:ring-4 focus:outline-none focus:ring-amber-600 font-medium rounded-lg text-md w-full sm:w-auto px-5 py-2.5 text-center dark:bg-regal-brown dark:hover:bg-amber-700 dark:focus:ring-amber-600">{{ t('admin.products.create_a_product') }}</button>
    
    </div>
    <div class="w-1/3"> 
        <div class="mb-6">
            <label for="description" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">{{ t('admin.products.description') }}</label>
        ...
        <div class="mb-4">
            <label for="image" class="block text-gray-700 dark:text-gray-200 font-bold mb-2">{{ t('admin.products.choose_a_product_image') }}</label>
