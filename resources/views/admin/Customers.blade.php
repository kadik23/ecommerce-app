...
<div class="flex flex-wrap items-stretch justify-between mt-5 ">
    ...
    <div class="m-3 px-16 flex flex-col justify-center bg-white border border-gray-200 rounded-lg shadow sm:py-3 dark:bg-gray-800 dark:border-gray-700">
        <h1 class="text-xl text-start font-bold">{{ t('admin.customers.conversion_rate') }}</h1>
        <div class="flex justify-between gap-6">
            <span class="text-regal-brown text-md p-2 font-semibold">{{ t('admin.customers.table.year') }}</span>
            <span class="text-regal-brown text-md p-2 font-semibold">{{ t('admin.customers.table.customers') }}</span>
            <span class="text-regal-brown text-md p-2 font-semibold">{{ t('admin.customers.table.revenue') }}</span>
        </div>
...
<div class="m-3 px-2 bg-white border border-gray-200 rounded-lg shadow p-8 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flow-root overflow-x-auto w-full">
        <div class="grid grid-cols-5 min-w-[600px] text-xs lg:text-base font-semibold text-center items-center py-4 border-b border-gray-200 dark:border-gray-700">
            <span class="text-regal-brown">{{ t('admin.customers.table.profile_image') }}</span>
            <span class="text-regal-brown">{{ t('admin.customers.table.fullname') }}</span>
            <span class="text-regal-brown">{{ t('admin.customers.table.email') }}</span>
            <span class="text-regal-brown">{{ t('admin.customers.table.revenue') }}</span>
            <span class="text-regal-brown">{{ t('admin.customers.table.country') }}</span>
        </div> 
